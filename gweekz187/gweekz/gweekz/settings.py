"""
Django settings for gweekz project.
...
SECRET_KEY = 'django-insecure-4^zqd_61b()r5586*z8k0+i-xs#is()m6seb#^%#rk8=pt2xzy'
...
WSGI_APPLICATION = 'gweekz.wsgi.application'
